        ...
        <div className="space-y-8">
           ...
           <div className="space-y-4">
              <input 
                ...
                className="w-full border rounded-xl p-3 focus:ring-2 ring-blue-500 outline-none"
           ...
           <div className="p-6 bg-slate-50 rounded-2xl space-y-4 border">
              <h3 className="font-bold flex items-center gap-2">
                <span className="w-8 h-8 bg-blue-600 text-white flex items-center justify-center rounded-lg">R</span>

          ...
          <div className="relative h-[500px] w-full bg-slate-100 rounded-[3rem] overflow-hidden border-8 border-white shadow-2xl">
            ...
            <div className="absolute inset-0 bg-[#e5e3df] overflow-hidden">
               ...
               <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                  <div className="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold border-4 border-white shadow-lg animate-pulse">
                    📍
                  </div>
            ...
            <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end gap-4 pointer-events-none">
               <div className="bg-white/90 backdrop-blur-md p-6 rounded-[2rem] shadow-2xl border border-white flex items-center gap-6 pointer-events-auto">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-bold text-blue-600">Verified Professional</p>
                  </div>
                  <button className="ml-4 w-12 h-12 bg-slate-900 text-white rounded-xl flex items-center justify-center hover:bg-blue-600 transition shadow-lg">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                  </button>
               </div>
               
               <div className="bg-blue-600 text-white px-8 py-5 rounded-[2rem] shadow-2xl text-center flex flex-col items-center pointer-events-auto">
        ...
        <div className="space-y-8">
           <div className="bg-white p-10 rounded-[3rem] border shadow-sm relative overflow-hidden">
              ...
              <div className="space-y-0 relative">
                 ...
                 <div 
                   className="absolute left-6 top-2 w-1 bg-blue-600 rounded-full transition-all duration-1000" 
                   style={{ height: `${(currentStep / (steps.length - 1)) * 100}%` }}
                 ></div>

                 {steps.map((step, idx) => (
                   <div key={idx} className="relative pl-16 pb-12 last:pb-0 flex flex-col">
                      <div className={`absolute left-4 w-5 h-5 rounded-full border-4 border-white shadow-md z-10 transition-all duration-500 ${idx <= currentStep ? 'bg-blue-600 scale-125' : 'bg-gray-200'}`}></div>
           ...
           <div className="bg-slate-900 text-white p-10 rounded-[3rem] shadow-2xl">
              <h3 className="text-lg font-black mb-4 uppercase tracking-widest text-blue-400">Security Note</h3>

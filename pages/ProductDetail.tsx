      ...
      <div className="flex flex-col lg:flex-row gap-16">
            ...
            <div className="md:w-24 flex md:flex-col gap-4">
              {galleryImages.map((img, i) => (
                <button 
                  ...
                  className={`flex-1 md:flex-none aspect-square rounded-2xl overflow-hidden border-4 transition-all duration-300 group hover:scale-105 ${activeImage === img ? 'border-blue-600 shadow-xl' : 'border-white shadow-sm opacity-60 hover:opacity-100'}`}
                >
        ...
        <div className="lg:w-1/2 space-y-10">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="px-5 py-2 bg-blue-50 text-blue-600 text-[10px] font-black rounded-full uppercase tracking-widest border border-blue-100">{product.category}</span>
          ...
          <div className="p-8 bg-slate-900 text-white rounded-[3rem] shadow-2xl relative overflow-hidden group">
             ...
             <h4 className="font-black flex items-center gap-3 mb-4 uppercase tracking-widest text-[10px] text-blue-400">
          ...
          <div className="pt-4 space-y-6">
            <div className="flex items-center gap-5 p-6 rounded-[2.5rem] bg-white border border-gray-100 shadow-sm">
               ...
               <div className="flex-1">
                 ...
                 <p className="text-[10px] font-black text-blue-500 uppercase tracking-widest">{product.location} Hub • {product.pincode}</p>
               </div>
            </div>
            ...
            {product.productType === ProductType.PLATFORM_SELL ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button 
                  ...
                  className="py-5 bg-blue-600 text-white rounded-[2rem] font-black text-sm uppercase tracking-widest hover:bg-slate-900 shadow-2xl shadow-blue-200 transition-all active:scale-95"
                >
                  Confirm Purchase
                </button>
                <button 
              ...
              <div className="space-y-4">
                ...
                {showContact ? (
                  ...
                  <button 
                    ...
                    className="w-full py-6 bg-slate-900 text-white rounded-[2rem] font-black text-sm uppercase tracking-widest hover:bg-blue-600 shadow-2xl transition-all active:scale-95"
                  >
                    Connect with Seller
                  </button>
                )}

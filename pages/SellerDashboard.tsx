  ...
  if (!user || user.role !== 'seller') {
    return (
      <div className="max-w-4xl mx-auto py-32 px-4 text-center">
        ...
        <button className="bg-slate-900 text-white px-10 py-4 rounded-2xl font-black text-sm uppercase shadow-2xl hover:bg-blue-600 transition">Become a Seller</button>
      </div>
    );
  }
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
        ...
        <button 
          ...
          className="bg-blue-600 text-white px-8 py-4 rounded-[2rem] font-black text-sm uppercase shadow-xl shadow-blue-200 hover:scale-[1.05] transition flex items-center gap-3"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
         {[
           ...
           { label: 'Active Listings', value: myProducts.length, icon: '📦', color: 'bg-blue-50 text-blue-600' },
           ...
           <div key={i} className="bg-white p-8 rounded-[2.5rem] border shadow-sm flex flex-col items-center text-center group hover:border-blue-200 transition">
         ...
         <div className="lg:col-span-2 space-y-8">
            ...
            {myProducts.length === 0 ? (
              <div className="p-32 border-4 border-dashed rounded-[3rem] text-center bg-gray-50 flex flex-col items-center">
                ...
                <button onClick={() => setIsListing(true)} className="mt-4 text-blue-600 font-bold hover:underline">List your first item now</button>
              </div>
            ) : (
                  ...
                  <div key={p.id} className="bg-white border rounded-[2rem] p-4 flex gap-6 hover:shadow-lg transition group">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex gap-4 mt-3">
                         <button className="text-[10px] font-black text-gray-400 hover:text-blue-600 uppercase tracking-widest border-b border-transparent hover:border-blue-600 transition">Modify</button>
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md z-[60] flex items-center justify-center p-4 overflow-y-auto">
           <div className="bg-white rounded-[3rem] w-full max-w-2xl p-10 relative animate-in zoom-in-95 duration-300">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full border-2 border-gray-100 rounded-2xl p-4 bg-gray-50 focus:bg-white outline-none focus:border-blue-600 transition"
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <button 
                  type="submit"
                  className="w-full py-5 bg-blue-600 text-white rounded-[2rem] font-black text-lg uppercase shadow-2xl shadow-blue-200 hover:bg-blue-700 transition transform active:scale-95"
                >
                  Confirm & List Item
                </button>
              </form>

    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      {cart.length === 0 ? (
        <div className="bg-white rounded-3xl border p-20 text-center space-y-6">
          ...
          <Link to="/marketplace" className="inline-block bg-blue-600 text-white px-8 py-3 rounded-full font-bold">Start Shopping</Link>
        </div>
      ) : (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="bg-white border rounded-3xl p-8 h-fit space-y-6 shadow-sm">
             ...
             <Link 
               to="/checkout"
               className="block w-full text-center py-4 bg-blue-600 text-white rounded-2xl font-bold hover:bg-blue-700 transition shadow-lg"
             >
               Checkout
             </Link>
